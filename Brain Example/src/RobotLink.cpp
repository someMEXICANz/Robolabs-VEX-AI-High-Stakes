...
/*---------------------------------------------------------------------------*/
//
RobotLink::RobotLink(int32_t index, const char *name, linkType type) : serial_link( index, name, type ) {
    // create threads
...
/*---------------------------------------------------------------------------*/
void
RobotLink::set_remote_location( double x, double y, double heading, int32_t status ) {
    txlock.lock();
...
/*---------------------------------------------------------------------------*/
void
RobotLink::get_local_location( double &x, double &y, double &heading, int32_t &status  ) {
    txlock.lock();
...
/*---------------------------------------------------------------------------*/
void
RobotLink::get_remote_location( double &x, double &y, double &heading ) {
    rxlock.lock();
...
/*---------------------------------------------------------------------------*/
bool
RobotLink::process( uint8_t data ) {
...
RobotLink::rx_task( void *arg  ) {
    ...
    // get our RobotLink instance
    //
    RobotLink *instance = static_cast<RobotLink *>(arg);
